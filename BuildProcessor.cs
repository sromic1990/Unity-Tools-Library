...
namespace UnityToolsLibrary
{
    public class BuildProcessor
    {
        ...
        public static void OnPostprocessBuild(BuildTarget buildTarget, string pathToBuiltProject)
        {
            ...
            //remove Metal from Required device capabilities
            string requiredDeviceCapabilities = "UIRequiredDeviceCapabilities";
            if(rootDict.values.ContainsKey(requiredDeviceCapabilities))
            {
                rootDict.values.Remove(requiredDeviceCapabilities);
